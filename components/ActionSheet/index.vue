    ...
    <TransitionRoot :show="show" appear>
      <div>
        ...
        <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0" enter-to="opacity-100"
          ...
          <div class="fixed bottom-0 z-50 flex w-screen" style="max-height: 66.666667%">
            <div
              class="relative flex flex-col justify-end flex-1 w-full px-4 pb-4 mx-auto space-y-1 overflow-y-auto max-w-8xl md:px-16">
              <slot />
            </div>
          </div>
        </TransitionChild>
