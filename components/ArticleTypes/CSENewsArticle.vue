<template>
  <div>
    ...
    >
      ...
      >
        <StockPriceWidget
          v-if="!article.isStockIndexArticle"
          class="w-full mb-8"
        ...
        >
          ...
          />
          <StocksChart
            v-if="block.component=='CSE_Chart'"
            class="mx-auto"
            :item="block"
          />
          <MarkdownSection
...
import StockPriceWidget from '../Widgets/StockMarket/StockPriceWidget'
import MarketIndexWidget from '../Widgets/StockMarket/MarketIndexWidget'
import StocksChart from '@/components/Widgets/StockMarket/StocksChart'
