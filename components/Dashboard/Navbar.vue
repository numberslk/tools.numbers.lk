    ...
    <template #menu>
      <div class="relative items-center hidden ml-auto lg:flex">
        ...
        <div class="flex space-x-4 border-l ml-6 pl-6 border-gray-900/10 dark:border-gray-50/[0.2]">
          ...
          <ThemeSwitcher />
          <Anchor
            class="flex items-center self-center text-lg hover:no-underline hover:text-slate-900 hover:dark:text-white"
            href="https://github.com/viandwi24/nuxt3-awesome-starter" title="Github">
            <IconMdi:github-face />
          </Anchor>
        </div>
      </div>
