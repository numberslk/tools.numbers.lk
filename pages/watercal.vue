                  ...
                  <div class="flex flex-col lg:flex-row">
                    <div class="relative flex w-full mb-2 lg:w-3/5 lg:mb-0">
                      <FormTextInput v-model="enteredNumberOfUnits" class="w-full">
                        <template #prefix-disabled>
                          <span class="flex-1 px-2 py-2 md:px-4"> {{
                    ...
                    <div class="relative flex w-full mb-2 lg:mb-0">
                      <div
                        ...
                        <span class="flex-1 px-2 py-2 md:px-4"><span class="flex-1 px-2 py-2 md:px-4"> {{
                    ...
                    <Button type="opposite" @click="calculateWaterBill" placeholder="Enter number of Units"
                      class="flex w-full mb-2 space-x-1 lg:w-3/5 lg:mb-0">
                      <icon-ic:baseline-calculate />
                      <span>{{ $t('others.calculate') }}</span>
                    </Button>
                    <MobileTopFixAd2 ad-slot="4452053156"
                      class="flex items-center justify-center mt-0 text-center md:hidden md:space-x-2" />
                  </div>
              ...
              <Card class="mb-4">
                <CardContent>
                  ...
                  <div class="flex flex-col lg:flex-row">
                    ...
                    <MobileTopFixAd2 ad-slot="2980023530"
                      class="flex items-center justify-center mt-0 text-center md:hidden md:space-x-2" />
                  </div>
                  <div class="flex flex-col mt-2 h-4/6">
                    <!-- Table -->
              ...
              <Card class="mb-4">
                <CardContent>
                  ...
                  <div class="flex flex-col lg:flex-row">
                    ...
                    <MobileTopFixAd2 ad-slot="4755305482"
                      class="flex items-center justify-center mt-0 text-center md:hidden md:space-x-2" />
                  </div>
                  <div class="flex flex-col mt-2 h-4/6">
                    <!-- Table -->
...
useHead(() => ({
  ...
  meta: [
    {
      name: 'description',
      content: 'The water bill calculator from Numbers.lk not only estimates monthly bills, but can be used to validate the accuracy of actual bills. This helps users identify any discrepancies and take action.',
    },
    {
      property: 'og:image',
      content: '../assets/images/water.png',
    },
  ],
}))
...
function calculateWaterBillFixedCharge(category: Number, units: Number, setting: String) {
...
function calculateWaterBill() {
  ...
  applicableFixedCharge.previous = Number(calculateWaterBillFixedCharge(category, numberOfUnits, "previous"));
  applicableFixedCharge.current = Number(calculateWaterBillFixedCharge(category, numberOfUnits, "current"));
  applicableFixedCharge.new = Number(calculateWaterBillFixedCharge(category, numberOfUnits, "new"));
